            ...
            <div className="mx-auto flex flex-col lg:flex-row lg:justify-center items-center max-w-3/4">
                ...
                className='px-8 lg:px-0 lg:w-2/4'>
                    ...
                    <div className='flex max-w-max gap-x-6 items-center mx-auto lg:mx-0 py-3'>
                        <a href="https://drive.google.com/file/d/1ME-c-UCxTdvkQb-byupXVB9GwRwbsvIb/view?usp=sharing" target="_blank"><button className='btn btn-sm lg:btn-lg'>View CV</button></a>

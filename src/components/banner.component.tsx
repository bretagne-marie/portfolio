            ...
            <div className='flex flex-col justify-around gap-y-6 lg:flex-row lg:items-center text-black/70'>
                <div className='text-center lg:text-left'>
                    ...
                    <motion.div
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        className='max-w-lg mx-auto lg:mx-0 font-tertiary py-3 text-[1rem] lg:text-[1.15rem]'>
                    ...
                    <motion.div
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        className='flex max-w-max gap-x-6 items-center mx-auto lg:mx-0 py-3'>
                    ...
                    <motion.div
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        className='flex text-[1.5rem] py-3 gap-x-6 max-w-max mx-auto lg:mx-0 lg:text-[2rem]'>
                ...
                <img src={BannerPic} alt='picture of Brittany Villegas' className='lg:w-2/5' />
            </div>
        </section>
    )
}
